...
fn main() {
    ...
    assert_eq!(score, Some(&98)); //.get() returns a pointer 
...
fn main() {
    ...
    // let team_map2 = teams.iter().map().collect();
...
#[derive(Hash,PartialEq,Debug,Eq)] //need these traits to implement hashmaps
struct Viking {
    name: String,
    country: String,
}
...
fn main() {
  ...
  m2.insert(&v2, v1); //inserts slice (&str) instead of String
